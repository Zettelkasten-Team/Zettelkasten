...
public class MacPainterFactory {
    ...
    public static MacWidgetsPainter<Component> createTexturedWindowWorkaroundPainter() {
        return new MacWidgetsPainter<Component>() {
            ...
            private Color ACTIVE_TOP_GRADIENT_COLOR = (PlatformUtils.isJava7OnMac()) ? new Color(0xdddddd) : new Color(0xbcbcbc);
            private Color ACTIVE_BOTTOM_GRADIENT_COLOR = (PlatformUtils.isJava7OnMac()) ? new Color(0xbbbbbb) : new Color(0x9a9a9a);
            private Color INACTIVE_TOP_GRADIENT_COLOR = (PlatformUtils.isJava7OnMac()) ? new Color(0xf1f1f1) : new Color(0xe4e4e4);
            private Color INACTIVE_BOTTOM_GRADIENT_COLOR = (PlatformUtils.isJava7OnMac()) ? new Color(0xdedede) : new Color(0xd1d1d1);
