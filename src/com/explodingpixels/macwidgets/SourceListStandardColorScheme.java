...
//    private static Color INACTIVE_BACKGROUND_COLOR = new Color(0xe8e8e8);
    private static Color ACTIVE_BACKGROUND_COLOR = new Color(0xe6ebf1);
    private static Color INACTIVE_BACKGROUND_COLOR = new Color(0xebebeb);

    private static final Color CATEGORY_FONT_COLOR = new Color(0x717e8c);
...
//        Color bottomColor = new Color(0x1956ad);
        ...
        Color topLineColor = new Color(0x6db1e3);
        // Color topLineColor = new Color(0x61a6dd);
        Color topColor = new Color(0x6db1e3);
        Color bottomColor = new Color(0x3d89d0);
...
//        Color bottomColor = new Color(0x7185ab);
        ...
        Color topLineColor = new Color(0xbdc7dc);
        // Color topLineColor = new Color(0xbcc5d6);
        Color topColor = new Color(0xbdc7dc);
        Color bottomColor = new Color(0x9caac4);
        return new GradientWithBorderPainter(topLineColor, bottomColor, topColor, bottomColor);
    }
