...
public class PlatformUtils {
     ...
     *
     * @return {@code true} if this JVM is running on a Mac.
     */
     ...
     *
     * @return {@code true} if this JVM is running Java 6 on a Mac.
     */
     ...
     *
     * @return {@code true} if this JVM is running Java 7 on a Mac.
     */
    ...
    /**
     * True if this JVM is running Java 8 on a Mac.
     *
     * @return {@code true} if this JVM is running Java 8 on a Mac.
     */
    public static boolean isJava8OnMac() {
        return isMac() && getJavaVersion().startsWith("1.8");
    }
    
    /**
     * True if this JVM is running 64 bit Java on a Mac.
     *
     * @return {@code true} if this JVM is running 64 bit Java on a Mac.
     */
     ...
     *
     * @return {@code true} if this JVM is running on Mac OS X 10.5, Leopard.
     */
    public static boolean isLeopard() {
        // return isMac() && getOsVersion().startsWith("10.8");
