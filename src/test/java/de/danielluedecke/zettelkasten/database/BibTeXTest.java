...
public class BibTeXTest {
	...
	public BibTeXTest() throws UnsupportedLookAndFeelException, IOException, ClassNotFoundException,
	...
	public void setUp() throws Exception {
		...
		this.zknFrame = new ZettelkastenView(this.singleFrameApplication, this.settings, this.tasksData);
