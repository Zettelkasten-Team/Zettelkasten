...
/**
 * This class contains generic constant values that are used all over the application.
 * 
 * 
...
public class Constants {
     ...
     */
    public static final String BUILD_VERSION = "3.2.4.3 nightly (Build 20140417)";
    /**
    ...
    /**
     * This constants stores the address of the file that contains update information for the current Zettelkasten:<br><br>
    ...
    /**
     * This constants stores the website-address where the Zettelkasten nightly builds can be downloaded:<br><br>
    ...
    /**
     * This constants stores the address of the file that contains update information for the nightly Zettelkasten builds:<br><br>
    ...
    /**
     * the appendinx to form-image-filenames, when we have the large-scaled form-image
     * for export.
     */
    ...
    /**
     * This constant determines when the timer, that is responsible for
     * the automatic backup of the data file, should start for the first time.
     */
    ...
    /**
     * A constant identifying which type of data was dragged and dropped. In this case, the
     * component is about to receive entry-numbers as comma-separated string.
     */
    public static final String DRAG_SOURCE_TYPE_ENTRIES = "entries";
    /**
     * A constant identifying which type of data was dragged and dropped. In this case, the
     * component is about to receive a node that was dragged inside this jTree.
     */
    public static final String DRAG_SOURCE_TYPE_NODE = "node";
    /**
     * A constant identifying which type of data was dragged and dropped. In this case, the
     * component is about to receive a bullet-point with its value stored as string.
     */
    public static final String DRAG_SOURCE_TYPE_BULLET = "bullet";
    /**
     * A constant identifying which type of data was dragged and dropped. In this case, the
     * component is about to receive keyword-index-numbers as comma-separated string.
     */
    public static final String DRAG_SOURCE_TYPE_KEYWORDS = "keywords";
    /**
     * A constant identifying which type of data was dragged and dropped. In this case, the
     * component is about to receive author-index-numbers as comma-separated string.
     */
    public static final String DRAG_SOURCE_TYPE_AUTHORS = "ZKN3_drag_authors";
    /**
     * A constant used for identifying the source of a drag&drop-operation. in this case, the drag-source
     * was the jTreeDesktop (mainwindows-frame)
     */
    public static final String DRAG_SOURCE_JTREEDESKTOP = "jTreeDesktop";
    /**
     * A constant used for identifying the source of a drag&drop-operation. in this case, the drag-source
     * was the jTreeLuhmann (mainwindows-frame)
     */
    ...
    /**
     * Constants that show which parts of an entry the user wants to apply a search-request.
     * we use binary shift options here, so we can OR the values.
     */
    ...
    /**
     * indicates that the user is searching for entries that lie within a certain created-period
     */
    public static final int SEARCH_WITH_CREATED_TIME = 7;
    /**
     * indicates that the user is searching for entries that lie within a certain edit-period
     */
    ...
    /**
     * indicates that the user is searching for entries that have <b>not</b> been rated
     */
     ...
     * to the CSearchResults-dialog-frame and displayed.<br><br>
     * We use the startSearch method for other purposes as well, for instance to retrieve
     * entries that should be added to the desktop or as manual links. in this case, we need
     * another constant to indicate that the search for entries is not meant that search results
     * should be displayed in the search results window.
     */
    public static final int STARTSEARCH_USUAL = 1;
    /**
     * this is a desktop-search, that means the search results are *not* shown in
     * the searchresults-window. instead, they are added to the desktop.<br><br>
     * We use the startSearch method for different purposes, for instance to retrieve
     * entries that should be added to the desktop or as manual links. depending on the purpose, we need
     * the related constant to indicate that the search for entries is not meant that search results
     * should be displayed in the search results window.
     */
    ...
    /**
     * Indicates that a search request focusses on certain entries that have been created during
     * a certain period.
     */
    public static final int TIMESTAMP_CREATED = 0;
    /**
     * Indicates that a search request focusses on certain entries that have been edited during
     * a certain period.
     */
    public static final int TIMESTAMP_EDITED = 1;
    /**
     * Indicates that a search request focusses on certain entries that have either been created
     * or edited during a certain period.
     */
    public static final int TIMESTAMP_BOTH = 2;


    /**
     * Used for the CBiggerEditField to indicate which kind of data
     * is being edited in the window
     */
    ...
    /**
     * Constant that indicates that the user wants medium sized icons for the toolbar.
     */
    public static final int TOOLBAR_SIZE_MEDIUM = 1;
    /**
     * Constant that indicates that the user wants small sized icons for the toolbar.
     */
    ...
    /**
     * Constants that indicate that the remarks of an entry should
     * also be displayed in the desktop-view
     */
    public static final int DESKTOP_SHOW_REMARKS = 1<<1;
    /**
     * Constants that indicate that the authors of an entry should
     * also be displayed in the desktop-view
     */
    public static final int DESKTOP_SHOW_AUTHORS = 1<<2;
    /**
     * Constants that indicate that the attachments of an entry should
     * also be displayed in the desktop-view
     */
    public static final int DESKTOP_SHOW_ATTACHMENTS = 1<<3;
    /**
     * Constants that indicate that the keywords of an entry should
     * also be displayed in the desktop-view
     */
    ...
    /**
     * Indicates whether no comments at all should be displayed in the desktop-window,
     * independent from whether desktop-entries have comments or not
     */
    public static final int DESKTOP_WITHOUT_COMMENTS = 1;
    /**
     * Indicates whether only comments and no entries should be displayed in the desktop-window.
     */
    public static final int DESKTOP_ONLY_COMMENTS = 2;
    
    
    /**
     * Constants that indicate which type of data format the user wants
     * to import/export.<br>
     ...
     * Constants that indicate which type of data format the user wants
     * to export his data to.<br><br>
     * {@code ZKN3} is the current file format, so data exported to this format
     * can be easily re-importet.
     */
    public static final int EXP_TYPE_ZKN3=8;
    /**
     * Constants that indicate which type of data format the user wants
     * to export <b>the desktop-content</b> (outliner) to.<br><br>
     * {@code RTF} stands for the RTF file format, i.e. RichTextFormat
     */
    ...
    /**
     * Indicates whether the user wants to export the desktop-data <i>without</i> any comments.
     */
    public static final int EXP_COMMENTS_NO = 0;
    /**
     * Indicates whether the user wants to export the desktop-data <i>with</i> any comments.
     */
    ...
    /**
     * Constant to define tha the main textfield "entry" in the new entry and main dialog has the focus.
     */
    public static final int FOCUS_FIELD_TEXT = 1;
    /**
     * Constant to define that the textfield "title" in the new entry dialog has the focus.
     */
    public static final int FOCUS_FIELD_TITLE = 2;
    /**
     * Constant to define that the textfield "authors" in the new entry and main dialog has the focus.
     */
    public static final int FOCUS_FIELD_AUTHOR = 3;
    /**
     * Constant to define that textfield "addkeywords" in the new entry dialog has the focus.
     */
    public static final int FOCUS_FIELD_ADDKEYWORDS = 4;
    /**
     * Constant to define that textfield "remarks" in the new entry and main dialog has the focus.
     */
    ...
    /**
     * Constant to define that the jTableAuthor in the mainframe's tabbed pane has the focus
     */
    public static final int FOCUS_TABLE_AUTHORS = 8;
    /**
     * Constant to define that the jTableKeywords in the mainframe's tabbed pane has the focus
     */
    public static final int FOCUS_TABLE_KEYWORDS = 9;
    /**
     * Constant to define that the jTableTitles in the mainframe's tabbed pane has the focus
     */
    public static final int FOCUS_TABLE_TITLES = 10;
    /**
     * Constant to define that the jTableAttachments in the mainframe's tabbed pane has the focus
     */
    ...
    /**
     * A string array that contains the different encodings that are used by the different reference-
     * managers when exporting their data to a bibtext file. use also {@link #BIBTEX_DESCRIPTIONS} to
     * retrieve the programmes' names associated with these encoding.<br><br>
     ...
     * use also {@link #BIBTEX_ENCODINGS} to retrieve the associated encoding for these programmes.<br><br>
     * 0: Bibliographix<br>
     * 1: BibDesk<br>
     * 2: Citavi<br>
    ...
    private static int getBibtexDescriptionIndex(String desc) {
        for (int i=0; i<BIBTEX_DESCRIPTIONS.length; i++) {
            if (BIBTEX_DESCRIPTIONS[i].equals(desc)) return i;
        }
        return 0;
    }
    
    /**
     * A reference to the BibDesk-value in the {@link #BIBTEX_DESCRIPTIONS BIBTEX_DESCRIPTIONS} string-array.
     */
    public static final int BIBTEX_DESC_BIBDESK_INDEX = getBibtexDescriptionIndex(BIBTEX_STRING_BIBDESK);
    /**
     * A reference to the Citavi-value in the {@link #BIBTEX_DESCRIPTIONS BIBTEX_DESCRIPTIONS} string-array.
     */
    public static final int BIBTEX_DESC_CITAVI_INDEX = getBibtexDescriptionIndex(BIBTEX_STRING_CITAVI);
    /**
     * A reference to the Mendeley-value in the {@link #BIBTEX_DESCRIPTIONS BIBTEX_DESCRIPTIONS} string-array.
     */
    ...
    /**
     * COnstant indicating that we want to create a reference list for a html-page when
     * exporting data. See CExportDlg fore more details.
     */
    public static final int REFERENCE_LIST_HTML = 1;
    /**
     * COnstant indicating that we want to create a reference list for a txt-page when
     * exporting data. See CExportDlg fore more details.
     */
    public static final int REFERENCE_LIST_TXT = 2;

    /**
     * Used in the CDesktop-class to indicate whether the deleted item from the jTree was a desktop-item,
     * i.e. the user wants to delete a complete desktop.
     */
    public static final int DEL_DESKTOP = 1;
    /**
     * Used in the CDesktop-class to indicate whether the deleted item from the jTree was a bullet-item,
     * i.e. the user wants to delete a bullet with its sub-entries
     */
    public static final int DEL_BULLET = 2;
    /**
     * Used in the CDesktop-class to indicate whether the deleted item from the jTree was an entry-item,
     * i.e. the user wants to delete a single entry (node).
     */
    ...
    /**
     * This is a constant for the image icon for question messages
     */
