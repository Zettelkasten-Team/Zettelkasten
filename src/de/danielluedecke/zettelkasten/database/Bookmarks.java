...
public class Bookmarks {
     ...
     * &nbsp;&nbsp;&lt;category&gt;<br>
     * &nbsp;&nbsp;&lt;bookmark&gt;<br>
     * &nbsp;&nbsp;&nbsp;&nbsp;&lt;entry id="5" cat="1"&gt;This is the comment of the bookmark&lt;/entry&gt;<br>
     * &nbsp;&nbsp;&nbsp;&nbsp;&lt;entry id="9" cat="2"&gt;This is the comment of the bookmark&lt;/entry&gt;<br>
     * &nbsp;&nbsp;&lt;/bookmark&gt;<br>
     * &lt;/bookmarks&gt;<br>
     * <br>
    ...
    /**
     * This method counts the amount of saved bookmarks, i.e. the number of elements within
     * the child-element "bookmark"
     * 
    ...
    /**
     * This method returns all categories in sorted order, as string array, or an empty array
     * if no categories exist.
     *
     * @return all categories in sorted order, as string array, or an empty array
     * if no categories exist.
     */
    ...
    /**
     * This method retrieves the bookmarked <b>entry-numbers</b> (<i>not</i> the index-numbers
     * of the bookmarks) that belong to the category {@code cat} (i.e. all entries that have been
     * bookmarked under the category {@code cat}).
     *
     * @param cat the bookmark-category
     * @return the entry-index-numbers (<b>not</b> bookmark-indes-numbers) that are bookmarked
     * under the category {@code cat} as integer array, or {@code null} if an error occured
     */
    ...
    /**
     * This method returns all entry-index-numbers (<b>not</b> bookmark-index-numbers) of all
     * bookmarked entries.
     *
     * @return an integer-array containing all entry-index-numbers of all bookmarked entries,
     * or {@code null} if no bookmarks exists
     */
    ...
    /**
     * This method counts the amount of saved categories, i.e. the number of elements within
     * the child-element "category"
     * 
    ...
    /**
     * This method retrieves all available bookmark-categories in alphabetically sorted order.
     *
     * @return a string array with all bookmark-categories, sorted alphabetically, or {@code null} if
     * no categories exist.
     */
     ...
     * position. used for other methods like {@link #getCategory(int) getCategory(int)}.
     * The position is a value from 0 to {@link #getCategoryCount() getCategoryCount()}-1.
     * 
    ...
    /**
     * This method deletes one or more bookmarks from the datafile. The numbers of the
     * bookmarked <i>entries</i> have to be passed as parameters.
     * 
     * @param bms an integer array with the entry-numbers of those entries that are bookmarked and
     * should be deleted.
     */
    ...
    /**
     * This method changes the category index of all bookmarks. All the old category-index-numbers
     * of bookmarks are changed to the new category-index.
     * 
    ...
    /**
     * This method returns the category-id (category-number) of a given bookmarked entry {@code nr}.
     * Use {@link #getBookmarkCategory(int) getBookmarkCategory(int)} if you want to get the category
     * of a bookmark with the index-number {@code nr}.
     *
    ...
    /**
     * This method changes the category-id (category-number) of a given bookmarked entry {@code nr}.
     *
     * @param nr the entry-number of a bookmarked entry (<b>not</b> the bookmark-id)
     ...
     * 
     * @param nr the bookmark-index-number as it appears in the database (<b>not</b> the entry-number of the bookmark)
     * @return the name of the bookmark's category, or null of no category-name was found
     */
