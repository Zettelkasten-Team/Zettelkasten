...
/**
 * This dialog displays various export settings that are defined by the user. In this
 * dialog, the user can specify the export-format, which elements of entries should
 * be exported and so on.
 * 
 * When the user clicks the apply-button, the dialog will be closed and the settings
 * can be retrieved via the various getter-methods.
 * 
...
public class CExport extends javax.swing.JDialog {
    ...
    public CExport(java.awt.Frame parent, Settings s, BibTex bt) {
        ...
        jCheckBoxAllInOne.setEnabled(false);
    ...
    private void initListeners() {
        ...
        jComboBox_exportType.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                jCheckBoxAllInOne.setEnabled(Constants.EXP_TYPE_XML==selectedIndex);
                if (!(Constants.EXP_TYPE_XML==selectedIndex)) jCheckBoxAllInOne.setSelected(false);
                //
                ...
                if (Constants.EXP_TYPE_XML==selectedIndex) {
                    jCheckBoxAllInOne.requestFocusInWindow();
                }
        ...
        jComboBoxCSVSeparator.addActionListener(new java.awt.event.ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                switch(jComboBoxCSVSeparator.getSelectedIndex()) {
                    case 0: csvseparator=','; break;
                    case 1: csvseparator=';'; break;
                    case 2: csvseparator='\t'; break;
                    default: csvseparator=','; break;
                }
            }
        });
    ...
    /**
     * This method is called whenever the user ticks a checkbox for those elements
     * which should be exportet. if we have no selection, i.e. no element should be
     * exportet, the export-button will be disabled. if at least one checkbox is
     * ticked, we can enable the excort-button.
     */
    ...
    private int getSelectedExportType(int sel) {
        ...
        switch (sel) {
            case 0: break;
            case TYPE_DOCX: selt = Constants.EXP_TYPE_DOCX; break;
            case TYPE_ODT: selt = Constants.EXP_TYPE_ODT; break;
            case TYPE_RTF: selt = Constants.EXP_TYPE_RTF; break;
            case TYPE_HTML: selt = Constants.EXP_TYPE_HTML; break;
            case TYPE_TXT: selt = Constants.EXP_TYPE_TXT; break;
            case TYPE_TEX: selt = Constants.EXP_TYPE_TEX; break;
            case TYPE_MD: selt = Constants.EXP_TYPE_MD; break;
            case TYPE_ZKN: selt = Constants.EXP_TYPE_ZKN3; break;
            case TYPE_XML: selt = Constants.EXP_TYPE_XML; break;
            case TYPE_CSV: selt = Constants.EXP_TYPE_CSV; break;
        }
        return selt;
    }
    ...
    public void startExport() {
        ...
        allinonefile = jCheckBoxAllInOne.isSelected();
        // check whether the xml-file should be exported in one file, or separated
        ...
        // "exportparts" finally contains all set bits for the parts of the data
        // which the user wants to export
        if (jCheckBox2.isSelected()) exportparts=exportparts|Constants.EXPORT_TITLE;
        if (jCheckBox3.isSelected()) exportparts=exportparts|Constants.EXPORT_CONTENT;
        if (jCheckBox4.isSelected()) exportparts=exportparts|Constants.EXPORT_AUTHOR;
        if (jCheckBox5.isSelected()) exportparts=exportparts|Constants.EXPORT_KEYWORDS;
        if (jCheckBox6.isSelected()) exportparts=exportparts|Constants.EXPORT_LINKS;
        if (jCheckBox7.isSelected()) exportparts=exportparts|Constants.EXPORT_REMARKS;
        if (jCheckBox8.isSelected()) exportparts=exportparts|Constants.EXPORT_TIMESTAMP;
        if (jCheckBox9.isSelected()) exportparts=exportparts|Constants.EXPORT_MANLINKS;
        if (jCheckBox10.isSelected()) exportparts=exportparts|Constants.EXPORT_LUHMANN;
        // save settings
    ...
    private void initComponents() {
        ...
        jCheckBoxAllInOne = new javax.swing.JCheckBox();
        ...
        jCheckBoxAllInOne.setText(resourceMap.getString("jCheckBoxAllInOne.text")); // NOI18N
        jCheckBoxAllInOne.setToolTipText(resourceMap.getString("jCheckBoxAllInOne.toolTipText")); // NOI18N
        jCheckBoxAllInOne.setName("jCheckBoxAllInOne"); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jCheckBoxAllInOne)
    ...
    private javax.swing.JCheckBox jCheckBoxAllInOne;
