...
public class CShowMultipleDesktopOccurences extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ResourceBundle bundle = ResourceBundle.getBundle("de.danielluedecke.zettelkasten.resources.CShowMultipleDesktopOccurences");
        jScrollPane1 = new JScrollPane();
        jTextArea1 = new JTextArea();
        jCheckBoxShowThisDlg = new JCheckBox();

        //======== this ========
        setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
        setTitle(bundle.getString("CMultipleDesktopEntries.title"));
        setName("CMultipleDesktopEntries");
        ...
        //---- jCheckBoxShowThisDlg ----
        jCheckBoxShowThisDlg.setText(bundle.getString("jCheckBoxShowThisDlg.text"));
        jCheckBoxShowThisDlg.setToolTipText(bundle.getString("jCheckBoxShowThisDlg.toolTipText"));
        jCheckBoxShowThisDlg.setName("jCheckBoxShowThisDlg");
    ...
    private JCheckBox jCheckBoxShowThisDlg;
