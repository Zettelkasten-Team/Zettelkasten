...
public class CStenoEdit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ResourceBundle bundle = ResourceBundle.getBundle("de.danielluedecke.zettelkasten.resources.CStenoEdit");
        ...
        setTitle(bundle.getString("FormStenoEdit.title"));
        setModal(true);
        setName("FormStenoEdit");
        ...
        //======== jScrollPane1 ========
        {
            ...
            //---- jTableSteno ----
            jTableSteno.setModel(new DefaultTableModel(
                new Object[][] {
                    {null, null},
                    {null, null},
                    {null, null},
            ...
            jTableSteno.setName("jTableSteno");
