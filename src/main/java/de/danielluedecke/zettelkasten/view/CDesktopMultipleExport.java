...
public class CDesktopMultipleExport extends javax.swing.JDialog {
     ...
     */
    private final DefaultListModel<String> desktopListModel = new DefaultListModel<String>();
    /**
     * 
     */
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance().getContext().getResourceMap(CDesktopMultipleExport.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(CDesktopMultipleExport.class, this);
