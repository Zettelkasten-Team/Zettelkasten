...
public class CSynonymsEdit extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ResourceBundle bundle = ResourceBundle.getBundle("de.danielluedecke.zettelkasten.resources.CSynonymsEdit");
        ...
        setTitle(bundle.getString("FormSynonymsEdit.title"));
        setMinimumSize(new Dimension(200, 200));
        setModal(true);
        setName("FormSynonymsEdit");
        Container contentPane = getContentPane();

        //======== jScrollPane1 ========
        {
            jScrollPane1.setBorder(null);
            jScrollPane1.setMinimumSize(new Dimension(30, 30));
        ...
        //---- jButtonFindNext ----
        jButtonFindNext.setToolTipText(bundle.getString("jButtonFindNext.toolTipText"));
        jButtonFindNext.setName("jButtonFindNext");
        jButtonFindNext.addActionListener(e -> jButtonFindNextActionPerformed(e));
        ...
        contentPaneLayout.setHorizontalGroup(
            contentPaneLayout.createParallelGroup()
                .addGroup(GroupLayout.Alignment.TRAILING, contentPaneLayout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(jTextFieldFind, GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
