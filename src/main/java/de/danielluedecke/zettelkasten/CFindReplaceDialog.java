...
public class CFindReplaceDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ResourceBundle bundle = ResourceBundle.getBundle("de.danielluedecke.zettelkasten.resources.CFindReplaceDialog");
        jPanel1 = new JPanel();
        jLabel1 = new JLabel();
        ...
        setTitle(bundle.getString("CFindReplaceDialog.title"));
        setAlwaysOnTop(true);
        setName("CFindReplaceDialog");
        setResizable(false);
        ...
        //======== jPanel1 ========
        {
            ...
            //---- jButtonFindNext ----
            jButtonFindNext.setName("jButtonFindNext");

            //---- jButtonFindPrev ----
            jButtonFindPrev.setName("jButtonFindPrev");

            //---- jButtonReplace ----
            jButtonReplace.setName("jButtonReplace");

            //---- jButtonReplaceAll ----
            jButtonReplaceAll.setName("jButtonReplaceAll");
            ...
            //---- jLabelMatches ----
            jLabelMatches.setText(bundle.getString("jLabelMatches.text"));
            jLabelMatches.setName("jLabelMatches");
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup()
                                    .addGroup(jPanel1Layout.createSequentialGroup()
                                        ...
                                        .addContainerGap())
                                    .addGroup(jPanel1Layout.createParallelGroup()
                                        .addComponent(jTextFieldFind, GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
                                        .addComponent(jTextFieldReplace, GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE))))))
            );
