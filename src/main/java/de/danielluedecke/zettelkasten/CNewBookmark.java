...
public class CNewBookmark extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ResourceBundle bundle = ResourceBundle.getBundle("de.danielluedecke.zettelkasten.resources.CNewBookmark");
        jLabel1 = new JLabel();
        jComboBoxCats = new JComboBox<>();
        jLabel2 = new JLabel();
        jTextFieldNewCat = new JTextField();
        jButtonAddCat = new JButton();
        jLabel3 = new JLabel();
        ...
        setTitle(bundle.getString("FormNewBookmark.title"));
        setModal(true);
        setName("FormNewBookmark");
        ...
        //---- jComboBoxCats ----
        jComboBoxCats.setModel(new DefaultComboBoxModel<>(new String[] {
            "Item 1",
            "Item 2",
            "Item 3",
            "Item 4"
        }));
        jComboBoxCats.setName("jComboBoxCats");
        ...
        //---- jTextFieldNewCat ----
        jTextFieldNewCat.setText(bundle.getString("jTextFieldNewCat.text"));
        jTextFieldNewCat.setName("jTextFieldNewCat");

        //---- jButtonAddCat ----
        jButtonAddCat.setName("jButtonAddCat");
                        ...
                        .addGroup(contentPaneLayout.createSequentialGroup()
                            .addGroup(contentPaneLayout.createParallelGroup()
                                .addGroup(contentPaneLayout.createSequentialGroup()
                                    ...
                                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                    .addComponent(jComboBoxCats, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
            ...
            contentPaneLayout.createParallelGroup()
                .addGroup(contentPaneLayout.createSequentialGroup()
                    ...
                    .addGroup(contentPaneLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                        .addComponent(jLabel2)
                        .addComponent(jButtonAddCat)
                        .addComponent(jTextFieldNewCat, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(jLabel3)
                    .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
    ...
    private JComboBox<String> jComboBoxCats;
    private JLabel jLabel2;
    private JTextField jTextFieldNewCat;
    private JButton jButtonAddCat;
