...
public class Constants {
	 ...
	 * information for the current Zettelkasten:<br>
	 * <br>
	...
	/**
	 * This constants stores the address of the file that contains update
	 * information for the nightly Zettelkasten builds:<br>
	 * <br>
	...
	public static boolean isJava7OnMac = System.getProperty("java.version").startsWith("1.7")
			&& System.getProperty("os.name").startsWith("Mac OS");
	public static boolean isJava8OnMac = System.getProperty("java.version").startsWith("1.8")
			&& System.getProperty("os.name").startsWith("Mac OS");
	/**
	...
	/**
	 * A constant identifying which type of data was dragged and dropped. In this
	 * case, the component is about to receive entry-numbers as comma-separated
	 * string.
	 */
	public static final String DRAG_SOURCE_TYPE_ENTRIES = "entries";
	/**
	 * A constant identifying which type of data was dragged and dropped. In this
	 * case, the component is about to receive a node that was dragged inside this
	 * jTree.
	 */
	public static final String DRAG_SOURCE_TYPE_NODE = "node";
	/**
	 * A constant identifying which type of data was dragged and dropped. In this
	 * case, the component is about to receive a bullet-point with its value stored
	 * as string.
	 */
	public static final String DRAG_SOURCE_TYPE_BULLET = "bullet";
	/**
	 * A constant identifying which type of data was dragged and dropped. In this
	 * case, the component is about to receive keyword-index-numbers as
	 * comma-separated string.
	 */
	public static final String DRAG_SOURCE_TYPE_KEYWORDS = "keywords";
	/**
	 * A constant identifying which type of data was dragged and dropped. In this
	 * case, the component is about to receive author-index-numbers as
	 * comma-separated string.
	 */
	public static final String DRAG_SOURCE_TYPE_AUTHORS = "ZKN3_drag_authors";
	/**
	 * A constant used for identifying the source of a drag&drop-operation. in this
	 * case, the drag-source was the jTreeDesktop (mainwindows-frame)
	 */
	public static final String DRAG_SOURCE_JTREEDESKTOP = "jTreeDesktop";
	/**
	 * A constant used for identifying the source of a drag&drop-operation. in this
	 * case, the drag-source was the jTreeLuhmann (mainwindows-frame)
	 */
	 ...
	 * search-request. we use binary shift options here, so we can OR the values.
	 */
	...
	/**
	 * Constants that show which search options the user chose.
	 */
	...
	public static final int SEARCH_OPTION_ACCENT_INSENSITIVE = 1 << 4;
	/**
	...
	/**
	 * indicates that the user is searching for entries that lie within a certain
	 * created-period
	 */
	...
	/**
	 * indicates that the user is searching for entries that have <b>not</b> been
	 * rated
	 */
	public static final int SEARCH_WITHOUT_RATINGS = 10;
	/**
	 * indicates that user wants to search entries that are top-level-entries in a
	 * note sequence (trailing entries, Folgezettel)
	 */
	public static final int SEARCH_TOP_LEVEL_LUHMANN = 11;
	/**
	 * indicates that user wants to search entries that are in a note sequence
	...
	/**
	 * indicates that user wants to search entries without any manual links
	 */
	 ...
	 * CSearchResults-dialog-frame and displayed.<br>
	 * <br>
	 * We use the startSearch method for other purposes as well, for instance to
	 * retrieve entries that should be added to the desktop or as manual links. in
	 * this case, we need another constant to indicate that the search for entries
	 * is not meant that search results should be displayed in the search results
	 * window.
	 */
	public static final int STARTSEARCH_USUAL = 1;
	/**
	 * this is a desktop-search, that means the search results are *not* shown in
	 * the searchresults-window. instead, they are added to the desktop.<br>
	 * <br>
	 ...
	 * depending on the purpose, we need the related constant to indicate that the
	 * search for entries is not meant that search results should be displayed in
	 ...
	 * the searchresults-window. instead, they are added as follower-numbers to the
	 * current entry.<br>
	 * <br>
	 * We use the startSearch method for different purposes, for instance to
	 * retrieve entries that should be added to the desktop or as manual links.
	 ...
	 * the searchresults-window. instead, they are added as manual links to the
	 * current entry.<br>
	 * <br>
	 * We use the startSearch method for different purposes, for instance to
	 * retrieve entries that should be added to the desktop or as manual links.
	...
	/**
	 * Indicates that a search request focusses on certain entries that have been
	 * created during a certain period.
	 */
	public static final int TIMESTAMP_CREATED = 0;
	/**
	 * Indicates that a search request focusses on certain entries that have been
	 * edited during a certain period.
	 */
	public static final int TIMESTAMP_EDITED = 1;
	/**
	 * Indicates that a search request focusses on certain entries that have either
	 * been created or edited during a certain period.
	 */
	public static final int TIMESTAMP_BOTH = 2;

	/**
	 * Used for the CBiggerEditField to indicate which kind of data is being edited
	 * in the window
	 */
	...
	/**
	 * Constants that indicate that the remarks of an entry should also be displayed
	 * in the desktop-view
	 */
	public static final int DESKTOP_SHOW_REMARKS = 1 << 1;
	/**
	 * Constants that indicate that the authors of an entry should also be displayed
	 * in the desktop-view
	 */
	...
	/**
	 * Indicates whether the comments should be displayed in the desktop-window, if
	 * desktop-entries have comments.
	 */
	public static final int DESKTOP_WITH_COMMENTS = 0;
	/**
	 * Indicates whether no comments at all should be displayed in the
	 * desktop-window, independent from whether desktop-entries have comments or not
	 */
	 ...
	 * Constants that indicate which type of data format the user wants to
	 * import/export.<br>
	 * TYPE_CSV are are comma separated values, CSV-files, as they can be used in
	...
	/**
	 * Constants that show which parts the user wants to export. we use binary shift
	 * options here, so we can OR the values.
	 */
	...
	/**
	 * Constants that indicate which type of data format the user wants to export
	 * his data to.<br>
	 * <br>
	 * {@code RTF} stands for the RTF file format, i.e. RichTextFormat
	 */
	 ...
	 * his data to.<br>
	 * <br>
	 * {@code XML} stands for the XML file format
	 */
	 ...
	 * his data to.<br>
	 * <br>
	 * {@code CSV} stands for the CSV file format, i.e. comma separated values
	 */
	 ...
	 * his data to.<br>
	 * <br>
	 * {@code HTML} stands for the HTML file format
	 */
	 ...
	 * his data to.<br>
	 * <br>
	 * {@code TXT} stands for the plain text file format
	 */
	 ...
	 * his data to.<br>
	 * <br>
	 * {@code TEX} stands for the LaTex file format
	 */
	 ...
	 * his data to.<br>
	 * <br>
	 * {@code ZKN3} is the current file format, so data exported to this format can
	 * be easily re-importet.
	 */
	public static final int EXP_TYPE_ZKN3 = 8;
	/**
	 * Constants that indicate which type of data format the user wants to export
	 * <b>the desktop-content</b> (outliner) to.<br>
	 * <br>
	 * {@code RTF} stands for the RTF file format, i.e. RichTextFormat
	 */
	 ...
	 * <b>the desktop-content</b> (outliner) to.<br>
	 * <br>
	 * {@code MD} stands for the Markdown format
	 */
	 ...
	 * <b>the desktop-content</b> (outliner) to.<br>
	 * <br>
	 * {@code ODT} stands for the OpenDocument Text file format
	 */
	 ...
	 * <b>the desktop-content</b> (outliner) to.<br>
	 * <br>
	 * {@code DOCX} stands for the Office Open XML file format
	 */
	 ...
	 * <b>the desktop-content</b> (outliner) to.<br>
	 * <br>
	 * {@code EPUB} stands for the ePub file format
	 */
	...
	/**
	 * Indicates whether the user wants to export the desktop-data <i>without</i>
	 * any comments.
	 */
	public static final int EXP_COMMENTS_NO = 0;
	/**
	 * Indicates whether the user wants to export the desktop-data <i>with</i> any
	 * comments.
	 */
	public static final int EXP_COMMENTS_YES = 1;
	/**
	 * Indicates whether the user wants to export only those desktop-entries that
	 * have any comments at all.
	 */
	public static final int EXP_COMMENTS_ONLY = 2;

	/**
	 * Constant to define tha the main textfield "entry" in the new entry and main
	 * dialog has the focus.
	 */
	public static final int FOCUS_FIELD_TEXT = 1;
	/**
	 * Constant to define that the textfield "title" in the new entry dialog has the
	 * focus.
	 */
	...
	/**
	 * Constant to define that textfield "addkeywords" in the new entry dialog has
	 * the focus.
	 */
	public static final int FOCUS_FIELD_ADDKEYWORDS = 4;
	/**
	 * Constant to define that textfield "remarks" in the new entry and main dialog
	 * has the focus.
	 */
	...
	/**
	 * Constant to define that the jTableAuthor in the mainframe's tabbed pane has
	 * the focus
	 */
	public static final int FOCUS_TABLE_AUTHORS = 8;
	/**
	 * Constant to define that the jTableKeywords in the mainframe's tabbed pane has
	 * the focus
	 */
	public static final int FOCUS_TABLE_KEYWORDS = 9;
	/**
	 * Constant to define that the jTableTitles in the mainframe's tabbed pane has
	 * the focus
	 */
	public static final int FOCUS_TABLE_TITLES = 10;
	/**
	 * Constant to define that the jTableAttachments in the mainframe's tabbed pane
	 * has the focus
	 */
	 ...
	 * different reference- managers when exporting their data to a bibtext file.
	 * use also {@link #BIBTEX_DESCRIPTIONS} to retrieve the programmes' names
	 * associated with these encoding.<br>
	 * <br>
	 ...
	 * 9: UTF-8 (Zotero)<br>
	 */
	public static final String[] BIBTEX_ENCODINGS = { "UTF-8", "UTF-8", "MacRoman", "UTF-8", "UTF-8", "ISO8859_1",
			"UTF-8", "ISO8859_1", "UTF-8", "UTF-8", "UTF-8", "UTF-8" };
	/**
	 * A string array that contains the different names of the reference managers.
	 * use also {@link #BIBTEX_ENCODINGS} to retrieve the associated encoding for
	 * these programmes.<br>
	 * <br>
	 * 0: Bibliographix<br>
	 * 1: BibDesk<br>
	 ...
	 * 9: Zotero<br>
	 */
	public static final String[] BIBTEX_DESCRIPTIONS = { "Bibliographix", "BibDesk", "Bookends (MacRoman)",
			"Bookends (UTF-8)", "Citavi", "Emacs/AucTex/RefTex", "Endnote", "JabRef (ISO8859_1)", "JabRef (UTF8)",
	...
	/**
	 * A reference to the BibDesk-value in the {@link #BIBTEX_DESCRIPTIONS
	 * BIBTEX_DESCRIPTIONS} string-array.
	 */
	public static final int BIBTEX_DESC_BIBDESK_INDEX = getBibtexDescriptionIndex(BIBTEX_STRING_BIBDESK);
	/**
	 * A reference to the Citavi-value in the {@link #BIBTEX_DESCRIPTIONS
	 * BIBTEX_DESCRIPTIONS} string-array.
	 */
	public static final int BIBTEX_DESC_CITAVI_INDEX = getBibtexDescriptionIndex(BIBTEX_STRING_CITAVI);
	/**
	 * A reference to the Mendeley-value in the {@link #BIBTEX_DESCRIPTIONS
	 * BIBTEX_DESCRIPTIONS} string-array.
	 */
	public static final int BIBTEX_DESC_MENDELEY_INDEX = getBibtexDescriptionIndex(BIBTEX_STRING_MENDELEY);

	public static final String[] LATEX_BIB_STYLES = { "First appearance (unsrt)", "Alphabetical (plain)",
			"Computer Journal (cj)", "Council of Biology Editors (cbe)",
			"Institute of Electrical and Electronics Engineers (IEEE)",
			"Institute of Electrical and Electronics Engineers (ieeetr)", "Nature (nature)",
			"Nucleic Acid Research (nar)" };

	public static final String[] LATEX_BIB_STYLECODE = { "unsrt", "plain", "cj", "cbe", "IEEE", "ieeetr", "nature",
			"nar" };

	public static final String[] LATEX_DOCUMENT_CLASS = { "Standard", "article", "report", "letter", "book", "slides" };
	...
	/**
	 * A constant indicating that a bibtex-entry is of type article within a book
	 */
	...
	/**
	 * Indicates the style of how a bibtex-entry should be returned when requested
	 * for display. These constants are also used when importing authors
	 */
	...
	/**
	 * COnstant indicating that we want to create a reference list for a html-page
	 * when exporting data. See CExportDlg fore more details.
	 */
	public static final int REFERENCE_LIST_HTML = 1;
	/**
	 * COnstant indicating that we want to create a reference list for a txt-page
	 * when exporting data. See CExportDlg fore more details.
	 */
	 ...
	 * jTree was a desktop-item, i.e. the user wants to delete a complete desktop.
	 */
	...
	/**
	 * Used in the CDesktop-class to indicate whether the deleted item from the
	 * jTree was an entry-item, i.e. the user wants to delete a single entry (node).
	 */
	...
	/**
	 * This is a constant for the image icon for comment nodes in the desktop window
	 */
	public static final ImageIcon iconDesktopComment = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/desktop_comment.png"));
	/**
	 * This is a constant for the image icon for follower number nodes in the
	 * desktop window
	 */
	public static final ImageIcon iconDesktopLuhmann = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/luhmann-number_desk.png"));
	public static final ImageIcon iconTopLuhmann = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/top_luhmann.png"));
	public static final ImageIcon iconNoTopLuhmann = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/no_top_luhmann.png"));
	public static final ImageIcon iconMiddleLuhmann = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/middle_luhmann.png"));

	/**
	 * This is the constant for the application's icon
	 */
	public static final ImageIcon zknicon = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/zkn3_16x16.png"));
	/**
	 * This is the constant for the application's icon
	 */
	public static final ImageIcon errorIcon = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/error.png"));
	/**
	 * This is the constant for the faded application's icon
	 */
	public static final ImageIcon errorIconFaded = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/error-grey.png"));
	/**
	 * This is the constant for the magnifier icon
	 */
	public static final ImageIcon lupeIcon = new ImageIcon(
			Constants.class.getResource("/de/danielluedecke/zettelkasten/resources/icons/magnifier.png"));
	/**
	 ...
	 */
	public static final String[] manualTimestamp = { "d.M.yyyy (HH:mm)", "d. MMM yyyy (HH:mm)", "d. MMMM yyyy (HH:mm)",
			"E, d.M.yyyy (HH:mm)", "E, d. MMM yyyy (HH:mm)", "E, d. MMMM yyyy (HH:mm)", "EEEE, d.M.yyyy (HH:mm)",
			"EEEE, d. MMM yyyy (HH:mm)", "EEEE, d. MMMM yyyy (HH:mm)", "yyyy-MM-dd HH:mm:ss" };
