...
package de.danielluedecke.zettelkasten.util.misc;

import java.util.Comparator;


/**
 * This is a simple comparer for the utils-sort-methods. we need
...
public class BackComparer implements Comparator {
    @Override public int compare(Object o1, Object o2) {
        ...
        String s1 = o2.toString().toLowerCase();
        String s2 = o1.toString().toLowerCase();
